...
\begin{tikzpicture}
    ...
    \path[draw,red!60,line width=1mm,
        decoration={zigzag,segment length=1.5em,amplitude=1.25mm},decorate]
        (270+17:2.5) -- (270+17:4.5);
    \pgftext{\includegraphics[width=12em]{figures/branching-cropped.png}} at (10:3);
\end{tikzpicture}
\end{document}
