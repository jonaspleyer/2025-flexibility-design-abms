...
\begin{itemize}
    ...
    \item \cite{Ghaffarizadeh2018,Gorochowski2012,Kang2014} Common choices for cellular representation (i.e. spherical cells, off-lattice approach)
...
\begin{figure}[H]
    \centering
    \includestandalone[width=0.9\columnwidth]{figures/generalized-modeling}
