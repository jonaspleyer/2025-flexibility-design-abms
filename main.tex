...
\newacro{cabmf}[CABMF]{Cellular Agent-Based Modeling Framework}
...
\title{
    Cellular Agent-Based Modelling Frameworks: We are not there yet
...
With this text, we argue that \acp{cabmf} need to become more flexible with respect to design of
agents and environment in order to tackle the aforementioned challenges.
...
properties.
These statements trivially hold true for \acp{pde} and \acp{mbs} where in the last term we can think
